...
const rows = [
  ...
  ["HOLD","Module interface","J1","TBD after measurement","Two-position VBATT/GND solder interface",1,0,"TBD","","Measure pad pitch, hole size, and mating method on LightHAB"],
...
summary.getRange("A3:B8").values = [
  ...
  ["Required populated PCB refs", 12],
...
summary.getRange("A11:F15").values = [
  ...
  ["2", "Measure LightHAB first", "J1/J2/J3 and all four mounting holes remain provisional until the purchased tracker is measured.", null, null, null],
...
holds.getRange("A2:D9").values = [
  ["LightHAB J1/J2/J3 interfaces","Vendor mechanical geometry is not published","Measure pitch, hole diameter, row location, orientation, and solder access on the purchased board","OPEN"],
  ...
  ["LightHAB VBATT/OUT1 behavior","Switch routing and pyro current rating are unverified","Bench-confirm switched VBATT and qualify OUT1 with an inert load before attaching nichrome","OPEN"],
];
