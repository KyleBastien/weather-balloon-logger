...
| D1 | LTST-C190KGKT | LED_SMD:LED_0603_1608Metric | LTST-C190KGKT (UNVERIFIED) | Green write-activity LED driven only during an SD write through R1. Verify polarity, footprint, visibility at about 1–2 mA, reverse leakage no greater than 1 µA, and −40 °C operation. GPIO-low OFF state creates no forward-current path and must meet the 1 µA LED-off limit. |
