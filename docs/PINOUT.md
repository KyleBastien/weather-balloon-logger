...
| J2 | 3 | 3V3 | LightHAB regulated 3.3 V for OpenLog VCC, C1/C2, the LED anode path, and R2 pull-up. |
...
| A1 | 3 | 3V3 | OpenLog VCC directly from LightHAB J2.3. |
...
- No VBATT interface or carrier logger regulator: J1 and A2 are intentionally removed because OpenLog accepts direct 3.3 V power.
